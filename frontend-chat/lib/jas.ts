// De dertien JAS-klassen met een vaste, onderscheidende badge-kleur per klasse. 1:1 overgenomen
// van wetsanalyse-ai's `frontend/lib/jas.ts` (en gelijk aan `api/app/shared/validation.py`'s
// `JAS_KLASSE_KLEUREN` — dezelfde canonieke bron, twee kanten van de keten). Onbekende klassen
...
const KLASSE_STYLE: Record<string, string> = {
  ...
  "Delegatiebevoegdheid en delegatie-invulling":
    "bg-[#b0b1b2] text-ink border-[#898a8a]",
...
/** Sorteersleutel voor presentatie: index in de canonieke wa-table-volgorde; onbekende klassen
 *  achteraan. Gebruik met een stabiele sort. */
