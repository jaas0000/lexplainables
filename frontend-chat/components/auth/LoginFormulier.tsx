...
// Minimale versie van frontend/'s `LoginFormulier` — geen TOTP/2FA-scherm (buiten scope voor
// deze eerste chat-UI-story).
export function LoginFormulier() {
  ...
  return (
    <form onSubmit={onSubmit} className="flex flex-col gap-4">
      ...
      <button type="submit" disabled={bezig} className="btn btn-primary w-full">
