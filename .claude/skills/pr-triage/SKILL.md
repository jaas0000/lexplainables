...
description: >-
  ...
  in de PR-beschrijving genoteerde vervolgpunten overzetten naar `docs/project/vervolgpunten.md` en
...
1. Bepaal de staat van de PR en handel dienovereenkomstig:
   ...
   **1a. "CI die niet draaide" ≠ "CI groen".** Een PR mag pas verder als de verplichte checks
   (zie `docs/project/architectuur/stack-profiel.md` §CI en `docs/project/werkwijze/CLAUDE.md` §Codestandaard: `check-generated-types`,
   ...
   (`docs/project/werkwijze/CLAUDE.md` §Verificatie-principe) er niet, en leun je stilzwijgend op been 2
...
4. **Vóór het mergen: verplaats vervolgpunten.** Staan er in de PR-beschrijving niet-blocking
   ...
   `docs/project/vervolgpunten.md` met een verwijzing naar de PR en de story.
...
5. **Bij het mergen: werk beide changelogs bij met de classificatie en samenvattingen die
   ...
   alleen:
   - `docs/project/changelog-technisch.md`: altijd een regel — `- <story/PR-titel> (PR #<nr>):
   ...
   **Commit regel 4 en 5 als een eigen, zichtbare commit op de PR-branch, vóór je mergt** — niet
   ...
   `docs/project/vervolgpunten.md` en de changelogs gewoon in de PR-geschiedenis, in plaats van iets dat
   achteraf nergens aan te herleiden is. Een technisch-geclassificeerde PR zonder vervolgpunten
   raakt alleen `docs/project/changelog-technisch.md`.
