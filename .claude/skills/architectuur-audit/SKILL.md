...
1. Lees breed, **per service**: pak de lijst services uit `docs/project/architectuur/stack-profiel.md` §Topologie en lees
...
5. Rapporteer bevindingen per zorg apart (duplicatie / cohesie / grenzen). Voer een
   ...
   signaleert maar niet direct oplost: zet direct in `docs/project/vervolgpunten.md` (er is geen PR om
   ...
   introduceren"): leg die vast als `docs/project/architectuur/adr/<nummer>-<naam>.md`, niet alleen als
...
6. **Registreer dat deze ronde heeft plaatsgevonden**, ook als er niets te melden was: een regel
   in `docs/project/vervolgpunten.md` met de datum en "architectuur-audit gedraaid, geen bevindingen"
