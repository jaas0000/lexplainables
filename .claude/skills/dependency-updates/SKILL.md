...
1. Haal de open Dependabot-PR's en -alerts op (`gh pr list --author app/dependabot`,
   ...
   frontend(s) en `.github/workflows/*.yml`. Zoek die lijst op in `docs/project/architectuur/stack-profiel.md` §Topologie
...
4. **Classificeer zelf voor de changelogs** bij een mechanische bump (er is geen `code-review`
   ...
   **technisch** (komt dus alleen in `docs/project/changelog-technisch.md`), plus een technische
