...
- De story-doc (`docs/project/stories/<nr>-<naam>.md`) — volledig
- `docs/project/architectuur/stack-profiel.md` — §Feature-eenheid, §De ene bron, §Migraties,
...
Sluit af met: "Plan opgeslagen in `docs/project/stories/<nr>-<naam>.md`. Klaar voor `feature-bouwen`."
