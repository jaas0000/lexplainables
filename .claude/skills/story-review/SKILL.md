...
**Trigger:** een nieuwe of gewijzigde user story in `docs/project/stories/`, vóór `feature-bouwen`
eraan begint.
...
1. Lees de story volledig. Toets tegen deze checklist:
   ...
   - **De service is benoemd** — bij welke service hoort deze feature (`docs/project/architectuur/stack-profiel.md`
