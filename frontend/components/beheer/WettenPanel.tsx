...
/** Wetcatalogus-tab van het instellingenvenster. Verplaatst uit
 *  `app/beheer/wetten/page.tsx` (werkwijze-story 042), inhoud ongewijzigd. */
export function WettenPanel() {
