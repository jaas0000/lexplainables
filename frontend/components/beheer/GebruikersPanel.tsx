...
/** Gebruikersbeheer-tab van het instellingenvenster. Verplaatst uit
 *  `app/beheer/gebruikers/page.tsx` (werkwijze-story 042), inhoud ongewijzigd. */
export function GebruikersPanel() {
