...
/** Feedback-tab van het instellingenvenster. Verplaatst uit `app/beheer/feedback/page.tsx`
 *  (werkwijze-story 042), inhoud ongewijzigd — alleen de "← Terug naar beheer"-link is vervallen:
 *  er is geen apart beheeroverzicht meer om naar terug te gaan, de tabbalk vervult die rol nu. */
