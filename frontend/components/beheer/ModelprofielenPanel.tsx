...
/** LLM-profielen-tab van het instellingenvenster. Verplaatst uit
 *  `app/beheer/llm-profielen/page.tsx` (werkwijze-story 042), inhoud ongewijzigd. */
export function ModelprofielenPanel() {
