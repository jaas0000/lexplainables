...
/** Account-tab van het instellingenvenster: profielgegevens, wachtwoord wijzigen, 2FA.
 *
 *  Verplaatst uit `app/account/page.tsx` (werkwijze-story 042) — inhoud ongewijzigd, alleen de
 *  paginaframing (default-export op een route) vervangen door een named export die
 *  `InstellingenInhoud` als tabpaneel rendert. */
