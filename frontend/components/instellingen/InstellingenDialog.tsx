...
/** Het instellingenvenster zoals je het vanuit de app opent: een gecentreerde dialoog over de
 *  huidige pagina heen. Sluiten gaat met `router.back()` — de intercepting route heeft een
 *  history-entry toegevoegd, dus daarmee land je terug op de pagina waar je vandaan kwam
...
export function InstellingenDialog({
  ...
  return (
    <Dialog label="Instellingen" onSluit={() => router.back()}>
