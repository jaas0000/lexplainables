...
lezen de lijst en de structuur (artikelen per wet) via wettenbank-MCP; admin-`resolve` kan
een bwb_id opzoeken.
...
actuele tekst komen live via `shared/wettenbank` uit de externe MCP-service — geen dubbele
opslag.
...
Beslissingen:
  ...
  - Story 010 §Databron: catalogus in eigen tabel, structuur (artikelen) live via
    wettenbank-MCP; geen caching van artikelen om drift met bronnen te voorkomen.
