...
Wat: beheerders schrijven release notes en aankondigingen (concept → gepubliceerd → gedepubliceerd); analisten lezen de gepubliceerde berichten en per-user wordt bijgehouden welke al gelezen zijn.
Waarom: eigen domein voor systeem-brede aankondigingen met eigen publicatie-levenscyclus en leesbewijzen — losstaand van feedback (dat is user→admin, dit is admin→user) en van user-identiteit.
