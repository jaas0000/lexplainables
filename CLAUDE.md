...
aanhef/considerans/ondertekenaars (032). GraphDB-licentie is geregeld (Free, Licensee:
...
dossier/toestandUrl/ondertekendDoor-triples geverifieerd via SPARQL). Nog niet gebouwd:
divisies/bijlagen — zie `docs/project/stories/027-bwb-import-graphdb-writer.md` §Buiten scope.
...
een werkende kernpijplijn incl. WTI-, artikel- en wet-brondata-verrijking (stories 024-028,
030-032, zie hierboven) — vervolg: bijlagen (033), divisies/circulaires (034), of verder naar
