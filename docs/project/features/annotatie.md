...
**Waarom apart:** annotatie is de kern-analyse-stap en heeft eigen levensduur, status-berekening en auditregels — geen slice van projecten (die orkestreert enkel), geen slice van wetcatalogus (die is puur lookup).
