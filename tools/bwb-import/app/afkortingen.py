...
Bewust klein en expliciet (geen poging tot volledigheid): alleen afkortingen die in de praktijk
in wetteksten en beleidsregels voorkomen. Het Burgerlijk Wetboek is per boek een eigen regeling;
het boeknummer zit in het artikelnummer ("6:162" -> Boek 6).
"""
...
def zoek_bwb_id(afkorting: str, artikelnummer: str) -> str | None:
    ...
    Voor "BW" bepaalt het boeknummer in het artikelnummer ("6:162" -> Boek 6) welke regeling
    bedoeld is.
    """
    if afkorting == "BW":
