"""GraphPort-adapter voor de GraphDB MCP-server (werkwijze-story 040).

`MCPClient` (`agent/mcp_client.py`) voldoet al aan het `GraphPort`-protocol; deze factory bouwt
er één uit `Settings`, inclusief het repository-id en de naam van de SPARQL-tool.
"""
